...
localizacion=['Madrid']
Anio=['2021','2022','2023']
ruta='D:\\Clima\\'+localizacion[0]+'\\TMY'
os.chdir(ruta)
filenameMens='Madrid_TMY_Hor.xlsx'
...
ClimaTrat = ClimaTrat.groupby('MesDia').agg({
        'Text_prm': ['mean'], 'Text_max': ['max'], 'Text_min': ['min'],
        'Hext_prm': ['mean'], 'Gh_prm': ['mean'], 'VVext_prm':['mean'] 
    })
