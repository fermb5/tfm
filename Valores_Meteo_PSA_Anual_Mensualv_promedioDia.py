...
for i in range(len(Anio)):
    ...
    ClimaTrat=ClimaTrat[['Año', 'Mes','Text_prm','Text_prm2','Text_max','Text_min','Hext_prm','Hext_prm2','Hext_max','Hext_min',
                        'Gh_prm','Gh_max','Gh_min','Gh_suma','Gh_num','VVext_prm','VVextN_prm','DVextN_prm','DVextN_num','VVextNE_prm','DVextNE_prm',
    ...
    os.chdir(rutames)
    filename='PSAyMet_'+Anio[1]+'_Mes.xlsx'
