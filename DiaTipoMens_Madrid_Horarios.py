...
temp.drop(['Año','Mes','Dia','Hora','Text_prm_Meteo','Hext_prm_Meteo','Gh_prm_Meteo'],axis=1,inplace=True)
fechas=[]
for i in range(12):
...
temp.columns=['Año','Mes','Dia','Text_prm', 'Hext_prm' ,'Gh_prm']
filenamediario='MadridyMet_DiaTipoHor_Exp12.xlsx'
ruta2='D:\\Clima\\'+localizacion[0]+'\\DiaTipo'
os.chdir(ruta2)
